...
enum {
    ...
    IMAGE_FLAGS_READONLY	= 0x02,	/* do not try to w__IMAGE_H_INCLUDEDrite to image (rom/flash) */
    IMAGE_FLAGS_INO_BITS	= 0x04	/* inode bits valid */
};


#define IMAGE_SIGNATURE		'i', 'm', 'a', 'g', 'e', 'f', 's'
#define IMAGE_SIGNATURE_REV	's', 'f', 'e', 'g', 'a', 'm', 'i'
struct image_header {
